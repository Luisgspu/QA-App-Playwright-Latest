...
class VehicleAPI:
    ...
    def fetch_models_for_market(self, market_code, test_name, model_code=None):
        ...
        """
        urls_list = self.fetch_urls_from_api(market_code, model_code)
    ...
    def validate_url_with_playwright(self, url):
        """Validates a URL using Playwright."""
        with sync_playwright() as p:
            ...
            try:
                ...
                logging.error(f"❌ Failed to validate URL: {url}. Error: {e}")
                return False
            finally:
                browser.close()
