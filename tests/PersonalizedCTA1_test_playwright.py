...
def test_personalized_cta_1(setup_browser):
    page = setup_browser
    ...
    with allure.step("✅ Interacting with the Personalized CTA"):
        ...
        page.wait_for_selector(cta_selector)
    ...
    # Take a screenshot
    screenshot_path = "screenshot.png"  # Define the path for the screenshot
    page.screenshot(path=screenshot_path)
    allure.attach.file(screenshot_path, name="Personalized CTA Screenshot", attachment_type=allure.attachment_type.PNG)
